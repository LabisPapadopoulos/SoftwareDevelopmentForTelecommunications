...
public class CacheManager implements Manager {
    ...
    //<androidId, androidDevice>
    Map<String, AndroidDevice> androidDevices;
    ...
    @Override
    public synchronized void addDeviceData(AndroidDevice androidDevice) throws SQLException {
        //Prosthikh sti vash
        manager.addDeviceData(androidDevice);
        
        //Prosthikh stin cache
        androidDevices.put(androidDevice.getAndroidId(), androidDevice);
    }
    ...
    @Override
    public synchronized List<String> getAndroidDevices() throws SQLException {
        return manager.getAndroidDevices();
    }
    ...
    @Override
    public synchronized AndroidDevice getAndroidDevice(String androidId) throws SQLException {
        
        if(androidDevices.get(androidId) == null) {
            androidDevices.put(androidId, manager.getAndroidDevice(androidId));
        }
        
        return androidDevices.get(androidId);
    }
